...
if __name__ == "__main__":
    if len(sys.argv) == 2:
        ...
        elif os.path.exists('news_clf_model.pkl') and os.path.exists('news_clf_feature_words.txt'):
            clf = joblib.load('news_clf_model.pkl')
            feature_words = []
            with open("news_clf_feature_words.txt", 'r') as f:
